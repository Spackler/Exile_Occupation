...
for "_i" from 1 to SC_numberofHeliCrashes do
{
	...
	_helicopter = ["Land_UWreck_MV22_F","CUP_A2_an2wreck","CUP_A2_uh1ywreck","Land_Wreck_Hunter_F"] call BIS_fnc_selectRandom;
	_vehHeli = _helicopter createVehicle [0,0,0];
	_heliFire = "test_EmptyObjectForSmoke" createVehicle (position _vehHeli);  
	...
	_box = ["CUP_RUBasicAmmunitionBox","CUP_USBasicAmmunitionBox_EP1","CUP_USBasicAmmunitionBox","CUP_USSpecialWeapons_EP1"] call BIS_fnc_selectRandom createvehicle _positionOfBox;
