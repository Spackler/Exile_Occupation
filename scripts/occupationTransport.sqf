...
//_transport setObjectTextureGlobal[0,"#(argb,8,8,3)color(1,0.91,0.24,0.8)"];
//_transport setObjectTextureGlobal [1,"#(argb,8,8,3)color(1,0.91,0.24,0.8)"];
//_transport setObjectTextureGlobal [2,"#(argb,8,8,3)color(1,0.91,0.24,0.8)"];
...
_transportDriver forceAddUniform "U_B_PilotCoveralls";
_transportDriver addVest "	V_TacVest_oli";
_transportDriver addHeadgear "H_CrewHelmetHeli_B";
...
else
{
    ...
    "transportLocation" setMarkerText "BFC Airlines";       
};
